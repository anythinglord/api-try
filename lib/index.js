...
const port$1 = process.env.SERVICES_PORT;
...
const port$3 = process.env.ALTERNATIVES_PORT;
...
const URLSave = `http://${url$3}:${port$3}/${savePoint}`;
...
const port$4 = process.env.REQUEST_PORT;
const entryPoint$3 = process.env.REQUEST_ENTRY;

const URL$3 = `http://${url$4}:${port$4}/${entryPoint$3}`;
